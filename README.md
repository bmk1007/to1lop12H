...
<body>
    ...
    <script>
        const songs = [
            { title: "Mở Lối Cho Em (Ss x Am Remix)", artist: "Lương Quý Tuấn", src: "song/Mở Lối Cho Em (Ss x Am Remix).mp3", cover: "l dũng.jpg" },
            { title: "Thay Tôi Yêu Cô Ấy (Style Huy PT Remix)(vừa khóc vừa làm tin)", artist: "Thanh Hưng", src: "https://res.cloudinary.com/dne9zjvt2/video/upload/v1771910835/Thay_T%C3%B4i_Y%C3%AAu_C%C3%B4_%E1%BA%A4y_Style_Huy_PT_Remix_izm8xu.mp3", cover: "cô gái tôi yêu.jpg" },
            { title: "Trả Cho Anh Remix x In The Club", artist: "Nguyễn Thạc Bảo Ngọc x QKhanh", src: "song/Trả Cho Anh Remix x In The Club.mp3", cover: "2.jpg" },
            { title: "doạn tuyệt nàng đi remix", artist: "PHÁT HUY T4 x DOMINO REMIX", src: "song/ĐOẠN TUYỆT NÀNG ĐI REMIX.mp3", cover: "3.jpg" },
            { title: "KHÔNG AI NÓI CHIA TAY", artist: "không nhớ:))", src: "song/Không Ai Nói Chia Tay Remix (Bản Hot TikTok).mp3", cover: "1.jpg" }
        ]
